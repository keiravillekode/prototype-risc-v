...
void test_false_start(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 2, 5};
    const int32_t list_two[] = {0, 1, 2, 3, 1, 2, 5, 6};
...
void test_consecutive(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 1, 2};
    const int32_t list_two[] = {0, 1, 1, 1, 2, 1, 2};
    TEST_ASSERT_EQUAL_INT(SUBLIST, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}

void test_sublist_at_start(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {0, 1, 2};
    const int32_t list_two[] = {0, 1, 2, 3, 4, 5};
    TEST_ASSERT_EQUAL_INT(SUBLIST, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}

void test_sublist_in_middle(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {2, 3, 4};
    const int32_t list_two[] = {0, 1, 2, 3, 4, 5};
    TEST_ASSERT_EQUAL_INT(SUBLIST, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}
...
void test_at_start_of_superlist(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {0, 1, 2, 3, 4, 5};
    const int32_t list_two[] = {0, 1, 2};
...
void test_second_list_missing_element_from_first_list(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 2, 3};
    const int32_t list_two[] = {1, 3};
    TEST_ASSERT_EQUAL_INT(UNEQUAL, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}

void test_first_list_missing_additional_digits_from_second_list(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 2};
    const int32_t list_two[] = {1, 22};
    TEST_ASSERT_EQUAL_INT(UNEQUAL, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}
...
void test_order_matters_to_a_list(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 2, 3};
    const int32_t list_two[] = {3, 2, 1};
    TEST_ASSERT_EQUAL_INT(UNEQUAL, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}

void test_same_digits_but_different_numbers(void) {
    TEST_IGNORE();
    const int32_t list_one[] = {1, 0, 1};
    const int32_t list_two[] = {10, 1};
    TEST_ASSERT_EQUAL_INT(UNEQUAL, sublist(list_one, ARRAY_SIZE(list_one), list_two, ARRAY_SIZE(list_two)));
}
