...
void test_when_last_saturday_in_february_in_a_nonleap_year_is_the_29th(void) {
    TEST_IGNORE();
    char buffer[BUFFER_SIZE];

    meetup(buffer, 2020, 2, LAST, SATURDAY);
    TEST_ASSERT_EQUAL_STRING("2020-02-29", buffer);
}
...
int main(void) {
    ...
    RUN_TEST(test_when_last_saturday_in_february_in_a_nonleap_year_is_the_29th);
